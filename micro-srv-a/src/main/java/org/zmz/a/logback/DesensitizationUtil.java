...
public class DesensitizationUtil {
                    ...
                    try {
                        ...
                        if (null != keyPatternValue && null != originalValue && !"null".equals(originalValue)) {
                            ...
                            if (!"null".equals(value) || value.equalsIgnoreCase(key)) {
                                ...
                                if (StringUtils.isNotEmpty(filterData)) {
            ...
            if (patternVale instanceof List) {
                ...
                if (!CollectionUtils.isEmpty(list)) {
                    ...
                    for (Map<String, Object> map : list) {
                        ...
                        if (StringUtils.isNotEmpty(patternValue)) {
                            return patternValue;
                        }
                    }
                }
    ...
    private String getPatternByMap(Map<String, Object> map, String value) {
        if (CollectionUtils.isEmpty(map)) {
            ...
            if (StringUtils.isNotEmpty(customRegex) && value.matches(customRegex)) {
                return position;
            } else {
                ...
                if (StringUtils.isNotEmpty(defaultRegex)) {
